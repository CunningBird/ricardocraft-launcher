package ru.ricardocraft.bff.asm;
...
import ru.ricardocraft.bff.binary.BuildContext;
import ru.ricardocraft.bff.binary.tasks.MainBuildTask;
...
public class InjectClassAcceptor implements MainBuildTask.ASMTransformer {
    private static final List<Class<?>> primitiveLDCClasses = Arrays.asList(Integer.class, Long.class,
