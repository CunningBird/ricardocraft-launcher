package ru.ricardocraft.bff.command.handler;

import ru.ricardocraft.bff.LaunchServer;
import ru.ricardocraft.bff.command.basic.*;
import ru.ricardocraft.bff.command.GenerateCertificateCommand;
import ru.ricardocraft.bff.command.hash.*;
import ru.ricardocraft.bff.command.mirror.*;
import ru.ricardocraft.bff.command.profiles.ProfilesCommand;
import ru.ricardocraft.bff.command.remotecontrol.RemoteControlCommand;
import ru.ricardocraft.bff.command.service.*;
import ru.ricardocraft.bff.command.sync.*;
import ru.ricardocraft.bff.command.tools.SignDirCommand;
import ru.ricardocraft.bff.command.tools.SignJarCommand;
import ru.ricardocraft.bff.command.OSSLSignEXECommand;
import ru.ricardocraft.bff.command.unsafe.*;
import ru.ricardocraft.bff.command.utls.BaseCommandCategory;
import ru.ricardocraft.bff.command.utls.CommandCategory;
import ru.ricardocraft.bff.command.basic.ClearCommand;
import ru.ricardocraft.bff.command.basic.GCCommand;
import ru.ricardocraft.bff.command.basic.HelpCommand;

public abstract class CommandHandler extends ru.ricardocraft.bff.command.utls.CommandHandler {
    public static void registerCommands(ru.ricardocraft.bff.command.utls.CommandHandler handler, LaunchServer server) {
