...
import ru.ricardocraft.bff.base.request.auth.password.*;
...
import ru.ricardocraft.bff.auth.core.interfaces.provider.AuthSupportExtendedCheckServer;
import ru.ricardocraft.bff.auth.core.interfaces.session.UserSessionSupportKeys;
import ru.ricardocraft.bff.auth.core.interfaces.user.UserSupportProperties;
import ru.ricardocraft.bff.auth.core.interfaces.user.UserSupportTextures;
