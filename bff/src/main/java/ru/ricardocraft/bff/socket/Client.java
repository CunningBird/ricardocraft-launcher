...
public class Client {
    ...
    public transient ru.ricardocraft.bff.auth.core.User coreObject;

    public transient ru.ricardocraft.bff.auth.core.UserSession sessionObject;
    ...
    public ru.ricardocraft.bff.auth.core.User getUser() {
