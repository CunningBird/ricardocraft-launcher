package ru.ricardocraft.bff.config;
...
import ru.ricardocraft.bff.auth.profiles.LocalProfileProvider;
import ru.ricardocraft.bff.auth.profiles.ProfileProvider;
import ru.ricardocraft.bff.auth.protect.ProtectHandler;
import ru.ricardocraft.bff.auth.protect.StdProtectHandler;
import ru.ricardocraft.bff.auth.texture.RequestTextureProvider;
import ru.ricardocraft.bff.auth.updates.LocalUpdatesProvider;
import ru.ricardocraft.bff.auth.updates.UpdatesProvider;
import ru.ricardocraft.bff.base.Launcher;
import ru.ricardocraft.bff.base.LauncherConfig;
import ru.ricardocraft.bff.components.AuthLimiterComponent;
import ru.ricardocraft.bff.components.Component;
import ru.ricardocraft.bff.components.ProGuardComponent;
