package ru.ricardocraft.backend.controller.files;
...
public class FilesController {
    ...
    public FilesController(DirectoriesService directoriesService, HttpServerProperties httpServerProperties) {
        this.base = directoriesService.getUpdatesDir();
        this.fullOut = true;
