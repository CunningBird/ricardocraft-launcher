package ru.ricardocraft.backend.dto.socket;

import com.fasterxml.jackson.annotation.JsonSubTypes;
import com.fasterxml.jackson.annotation.JsonTypeInfo;
import ru.ricardocraft.backend.dto.socket.auth.*;
import ru.ricardocraft.backend.dto.socket.cabinet.AssetUploadInfoResponse;
import ru.ricardocraft.backend.dto.socket.cabinet.GetAssetUploadInfoResponse;
import ru.ricardocraft.backend.dto.socket.management.FeaturesResponse;
import ru.ricardocraft.backend.dto.socket.management.GetConnectUUIDResponse;
import ru.ricardocraft.backend.dto.socket.management.GetPublicKeyResponse;
import ru.ricardocraft.backend.dto.socket.profile.BatchProfileByUsername;
import ru.ricardocraft.backend.dto.socket.profile.ProfileByUUIDResponse;
import ru.ricardocraft.backend.dto.socket.profile.ProfileByUsername;
...
import ru.ricardocraft.backend.dto.socket.secure.VerifySecureLevelKeyResponse;
