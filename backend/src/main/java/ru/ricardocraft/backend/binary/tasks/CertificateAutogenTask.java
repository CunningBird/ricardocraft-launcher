...
public class CertificateAutogenTask implements LauncherBuildTask {
    ...
    public CertificateAutogenTask(LaunchServerConfig config, KeyAgreementManager keyAgreementManager) {
        this.config = config;
    ...
    public Path process(Path inputFile) throws IOException {
        ...
        try {
            ...
            subject.addRDN(BCStyle.CN, config.projectName.concat(" Autogenerated"));
            subject.addRDN(BCStyle.O, config.projectName);
