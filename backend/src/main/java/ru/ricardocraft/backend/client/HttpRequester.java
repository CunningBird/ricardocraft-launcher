...
import ru.ricardocraft.backend.client.error.HttpErrorHandler;
import ru.ricardocraft.backend.client.error.HttpOptional;
import ru.ricardocraft.backend.client.error.SimpleError;
import ru.ricardocraft.backend.client.error.SimpleErrorHandler;
