...
public final class IndexAssetService {
    ...
    public void indexAsset(String indexInputAssetDirName, String indexIndexFileName, String outputOutputAssetDirName) throws Exception {
