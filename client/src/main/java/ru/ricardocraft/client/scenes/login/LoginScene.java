...
public class LoginScene extends AbstractScene {
    ...
    public LoginScene(JavaFXApplication application,
        ...
        super("scenes/login/login.fxml", application, config, guiModuleConfig, authService, launchService);
        this.config = config;
