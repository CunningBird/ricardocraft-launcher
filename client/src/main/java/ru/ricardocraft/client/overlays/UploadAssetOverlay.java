...
import ru.ricardocraft.client.base.request.cabinet.GetAssetUploadUrl;
...
public class UploadAssetOverlay extends CenterOverlay {
    ...
    public UploadAssetOverlay(JavaFXApplication application,
        ...
        super("overlay/uploadasset/uploadasset.fxml", application, guiModuleConfig, launchService);
    ...
    public void uploadAsset(String name, AssetOptions options) {
        ...
        application.gui.processingOverlay.processRequest(currentStage, launchService.getTranslation("runtime.overlay.processing.text.uploadasset"), new GetAssetUploadUrl(name), (e) -> {
