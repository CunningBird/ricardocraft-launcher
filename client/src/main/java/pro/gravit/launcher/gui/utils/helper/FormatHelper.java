...
public class FormatHelper {
    public static Ansi rawAnsiFormat(pro.gravit.launcher.gui.utils.helper.LogHelper.Level level, String dateTime, boolean sub) {
        Ansi.Color levelColor;
        boolean bright = level != pro.gravit.launcher.gui.utils.helper.LogHelper.Level.DEBUG;
