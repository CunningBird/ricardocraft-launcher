...
public abstract class LauncherModule {
    protected final pro.gravit.launcher.gui.base.modules.LauncherModuleInfo moduleInfo;
    ...
    private pro.gravit.launcher.gui.base.modules.LauncherModulesContext context;
    private LauncherTrustManager.CheckClassResult checkResult;

    protected LauncherModule() {
        moduleInfo = new pro.gravit.launcher.gui.base.modules.LauncherModuleInfo("UnknownModule");
    }

    protected LauncherModule(pro.gravit.launcher.gui.base.modules.LauncherModuleInfo info) {
        moduleInfo = info;
    }
     ...
     */
    public final void setContext(pro.gravit.launcher.gui.base.modules.LauncherModulesContext context) {
