...
public final class IOHelper {
    ...
    // Charset
    public static final int SOCKET_TIMEOUT = pro.gravit.launcher.gui.utils.helper.VerifyHelper.verifyInt(
            Integer.parseUnsignedInt(System.getProperty("launcher.socketTimeout", Integer.toString(30000))),
            pro.gravit.launcher.gui.utils.helper.VerifyHelper.POSITIVE, "launcher.socketTimeout can't be <= 0");
    public static final int HTTP_TIMEOUT = pro.gravit.launcher.gui.utils.helper.VerifyHelper.verifyInt(
            Integer.parseUnsignedInt(System.getProperty("launcher.httpTimeout", Integer.toString(5000))),
            pro.gravit.launcher.gui.utils.helper.VerifyHelper.POSITIVE, "launcher.httpTimeout can't be <= 0");
    // Constants
    public static final int BUFFER_SIZE = pro.gravit.launcher.gui.utils.helper.VerifyHelper.verifyInt(
            Integer.parseUnsignedInt(System.getProperty("launcher.bufferSize", Integer.toString(4096))),
            pro.gravit.launcher.gui.utils.helper.VerifyHelper.POSITIVE, "launcher.bufferSize can't be <= 0");
    ...
    public static void close(AutoCloseable closeable) {
        try {
            ...
            pro.gravit.launcher.gui.utils.helper.LogHelper.error(exc);
        }
    }
    ...
    public static String verifyFileName(String fileName) {
        return pro.gravit.launcher.gui.utils.helper.VerifyHelper.verify(fileName, IOHelper::isValidFileName, String.format("Invalid file name: '%s'", fileName));
    }
