...
import pro.gravit.launcher.gui.utils.launch.ModuleHacks;
            ...
            if(options.moduleConf != null) {
                ...
                for(var e : options.moduleConf.exports.entrySet()) {
                    ...
                    if(options.enableHacks && source.getLayer() != layer) {
                        pro.gravit.launcher.gui.utils.launch.ModuleHacks.createController(hackLookup, source.getLayer()).addExports(source, pkg, target);
                    } else {
                ...
                for(var e : options.moduleConf.opens.entrySet()) {
                    ...
                    if(options.enableHacks && source.getLayer() != layer) {
                        pro.gravit.launcher.gui.utils.launch.ModuleHacks.createController(hackLookup, source.getLayer()).addOpens(source, pkg, target);
                    } else {
