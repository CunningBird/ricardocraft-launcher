...
public class OfflineRequestService implements RequestService {
    ...
    public <T extends WebSocketEvent, V extends pro.gravit.launcher.gui.base.request.websockets.WebSocketRequest> void registerRequestProcessor(Class<V> requestClazz, RequestProcessor<T, V> function) {
