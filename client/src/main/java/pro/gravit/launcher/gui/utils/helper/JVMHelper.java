...
public final class JVMHelper {
    ...
    public static void fullGC() {
        RUNTIME.gc();
        pro.gravit.launcher.gui.utils.helper.LogHelper.debug("Used heap: %d MiB", RUNTIME.totalMemory() - RUNTIME.freeMemory() >> 20);
    }
    ...
    public static void checkStackTrace(Class<?> mainClass) {
        pro.gravit.launcher.gui.utils.helper.LogHelper.debug("Testing stacktrace");
    ...
    public static void verifySystemProperties(Class<?> mainClass, boolean requireSystem) {
        ...
        // Verify class loader
        pro.gravit.launcher.gui.utils.helper.LogHelper.debug("Verifying class loader");
