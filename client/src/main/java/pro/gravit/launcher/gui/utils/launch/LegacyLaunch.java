...
public class LegacyLaunch implements Launch {
    ...
    @Override
    public pro.gravit.launcher.gui.utils.launch.ClassLoaderControl init(List<Path> files, String nativePath, LaunchOptions options) {
        ...
        }).toArray(URL[]::new), pro.gravit.launcher.gui.utils.launch.BasicLaunch.class.getClassLoader());
    ...
    private class LegacyClassLoader extends URLClassLoader {
        ...
        private final List<pro.gravit.launcher.gui.utils.launch.ClassLoaderControl.ClassTransformer> transformers = new ArrayList<>();
        ...
        protected Class<?> findClass(String name) throws ClassNotFoundException {
            ...
            if(name != null && !transformers.isEmpty()) {
                ...
                for(pro.gravit.launcher.gui.utils.launch.ClassLoaderControl.ClassTransformer t : transformers) {
