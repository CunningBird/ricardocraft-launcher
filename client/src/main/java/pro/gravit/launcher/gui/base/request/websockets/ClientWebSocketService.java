...
public abstract class ClientWebSocketService extends ClientJSONPoint {
    ...
    public static final ProviderMap<pro.gravit.launcher.gui.base.request.websockets.WebSocketRequest> requests = new ProviderMap<>();
    ...
    public static void appendTypeAdapters(GsonBuilder builder) {
        ...
        builder.registerTypeAdapter(pro.gravit.launcher.gui.base.request.websockets.WebSocketRequest.class, new UniversalJsonAdapter<>(ClientWebSocketService.requests));
