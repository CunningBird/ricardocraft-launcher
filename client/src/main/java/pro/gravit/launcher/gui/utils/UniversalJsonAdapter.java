...
/**
 * An adapter that uses {@link pro.gravit.launcher.gui.utils.ProviderMap} to serialize and deserialize a group of similar objects
 *
 * @param <R> Class or interface type
 * @see pro.gravit.launcher.gui.utils.ProviderMap
 */
public class UniversalJsonAdapter<R> implements JsonSerializer<R>, JsonDeserializer<R> {
    public final pro.gravit.launcher.gui.utils.ProviderMap<R> providerMap;
    public final String name;
    public final String PROP_NAME;
    public Class<? extends R> defaultClass;

    public UniversalJsonAdapter(pro.gravit.launcher.gui.utils.ProviderMap<R> providerMap) {
        this.providerMap = providerMap;
        this.name = providerMap.getName();
        this.PROP_NAME = "type";
    }

    public UniversalJsonAdapter(pro.gravit.launcher.gui.utils.ProviderMap<R> providerMap, String PROP_NAME) {
        this.providerMap = providerMap;
        this.name = providerMap.getName();
        this.PROP_NAME = PROP_NAME;
    }

    public UniversalJsonAdapter(pro.gravit.launcher.gui.utils.ProviderMap<R> providerMap, String name, Class<? extends R> defaultClass) {
        this.providerMap = providerMap;
        this.name = name;
    ...
    public UniversalJsonAdapter(pro.gravit.launcher.gui.utils.ProviderMap<R> providerMap, Class<? extends R> defaultClass) {
        this.providerMap = providerMap;
        this.defaultClass = defaultClass;
        this.name = providerMap.getName();
        this.PROP_NAME = "type";
